    ...
    function _7f2(_7f3,_7f4){
        ...
        if(opts.mode=="h"){
            ...
            if(!isNaN(opts.width)){
                ...
                var len = _7f5.find("div.slider-rulelabel")[0].all.length-1;
                var _7f5Text = _7f5.find("div.slider-rulelabel")[0].all[len].innerHTML;
                var num = Number(_7f5Text);
                $.each(_7f5.find("div.slider-rulelabel")[0].all,function(i,v){
                ...
                if(num&&!isNaN(num)){
                    ...
                    if(_7f5Text === "不透明"){
                    _7f5.find("div.slider-rulelabel")[0].all[len].style.width = "60px";
                    //_7f5.find("div.slider-rulelabel")[0].all[len].clientWidth = "73px";
                    //_7f5.find("div.slider-rulelabel")[0].all[len].offsetWidth = "73px";
                    _7f5.find("div.slider-rulelabel")[0].all[len].style.color = "#fffffe";
                    }
                }
            }
        }else{
