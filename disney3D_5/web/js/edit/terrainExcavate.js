                    ...
                    if(!isShowResult && bShow){
                        ...
                        if(cArr.length>1){
                            ...
                            if(result.RecordCount > 0)
                            {
                                ...
                                htmlStr = '<div style="word-break:keep-all;white-space:nowrap;overflow:auto;width:265px;height:310px;margin-top:25px;margin-bottom:25px"><table >';
...
var initNotLineValue = function (layerID, record, obj){
    var stylestr="style='border: 1px solid #808080;  background-color:#ffffff;   font-size:11px;  padding-left:5px;  padding-right:5px; text-align:left;'";
    ...
    var strKey=record[top.getName("US_KEY",0,true)];
                                ...
                                earth.Event.OnEditDatabaseFinished = function(pRes, pFeature){
                                    if (pRes.ExcuteType == parent.excuteType){
                                        ...
                                        var str = "";
                                       // str += '<tr><td '+stylestr+'> '+str_caption+'</td><td  '+stylestr+'> '+  "&nbsp;&nbsp;" +record[top.getName("US_KEY",0,true)]+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+'X坐标</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +X+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+'Y坐标</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +Y+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+altitude_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+altitude+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+pointType_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(pointType==undefined?"":pointType)+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+attachment_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(attachment==undefined?"":attachment)+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+road_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+road+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+owner_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+owner+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+bdTime_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+bdTime+'</td></tr>';
                                        str += '<tr><td '+stylestr+'> '+state_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+state+'</td></tr>';
                                        //alert("大概");
                                        //井相关字段处理
                                        if(us_well){
                                            str += '<tr><td '+stylestr+'> '+us_well_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_well+'</td></tr>';
                                        }
                                        if(us_wdia && Number(us_wdia)){
                                            us_wdia = Number(us_wdia).toFixed(3);
                                            str += '<tr><td '+stylestr+'> '+us_wdia_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_wdia+'</td></tr>';
                                        }
                                        if(us_ndeep && Number(us_ndeep)){
                                            us_ndeep = Number(us_ndeep).toFixed(3);
                                            str += '<tr><td '+stylestr+'> '+us_ndeep_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_ndeep+'</td></tr>';
                                        }
                                        if(us_wdeep && Number(us_wdeep)){
                                            us_wdeep = Number(us_wdeep).toFixed(3);
                                            str += '<tr><td '+stylestr+'> '+us_wdeep_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_wdeep+'</td></tr>';
                                        }
                                        if(us_plate){
                                            str += '<tr><td '+stylestr+'> '+us_plate_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_plate+'</td></tr>';
                                        }
                                        if(us_psize){
                                            str += '<tr><td '+stylestr+'> '+us_psize_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_psize+'</td></tr>';
                                        }
                                        if(us_pmater){
                                            str += '<tr><td '+stylestr+'> '+us_pmater_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_pmater+'</td></tr>';
                                        }
                                        if(us_wmater){
                                            str += '<tr><td '+stylestr+'> '+us_wmater_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_wmater+'</td></tr>';
                                        }
                                        if(us_angle && Number(us_angle)){
                                            us_angle = Number(us_angle).toFixed(3);
                                            str += '<tr><td '+stylestr+'> '+us_angle_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_angle+'</td></tr>';
                                        }
                                        if(us_offset){
                                            str += '<tr><td '+stylestr+'> '+us_offset_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;" +us_offset+'</td></tr>';
                                        }
...
var initLineValue = function (layerID, record, layerName){
    var stylestr="style='border: 1px solid #808080;  background-color:#ffffff;   font-size:11px;  padding-left:5px;  padding-right:5px; text-align:left;'";
        ...
        var str = "";
      //  str += '<tr><td  width="100" '+stylestr+'> ' + str_caption +'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+record[top.getName("US_KEY",1,true)]||""+'</td></tr>';
        str += '<tr><td '+stylestr+'> '+US_LTTYPE_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+lineType+'</td></tr>';
        str += '<tr><td '+stylestr+'> '+us_pmater_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(material==undefined?"":material)+'</td></tr>';
        if(diam!= 0){
            str += '<tr><td '+stylestr+'> '+US_PDIAM_caption+'</td><td '+stylestr+'> '+ "&nbsp;&nbsp;"+diam+'</td></tr>';
        }
        var layer=earth.LayerManager.GetLayerByGUID(layerID);
        ...
        if ((intLayerCode >= 5000 && intLayerCode < 6000)||(intLayerCode >= 6000 && intLayerCode < 7000)||(intLayerCode >= 7000 && intLayerCode < 8000)){
            ...
            str += '<tr><td '+stylestr+'> '+pressur_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(pressur!=undefined?pressur:"")+'</td></tr>';
        }
        //压力
        if(intLayerCode >= 1000 && intLayerCode < 2000){
            ...
            str += '<tr><td '+stylestr+'> '+voltage_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(voltage==undefined?"":voltage)+'</td></tr>';
        }
        //排水和工业管道显示
        if ((intLayerCode >= 4000 && intLayerCode < 5000)||(intLayerCode >= 7000 && intLayerCode < 8000)){
            ...
            str += '<tr><td '+stylestr+'> '+flower_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(flower==undefined?"":flower)+'</td></tr>';
        }
        //电力、电信
        if ((intLayerCode >= 1000 && intLayerCode < 2000)||(intLayerCode >= 2000 && intLayerCode < 3000)){
            ...
            str += '<tr><td '+stylestr+'> '+ventnum_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(ventnum==undefined?"":ventnum)+'</td></tr>';
            str += '<tr><td '+stylestr+'> '+holeto_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(holeto==undefined?"":holeto)+'</td></tr>';
            str += '<tr><td '+stylestr+'> '+holeused_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(holeused==undefined?"":holeused)+'</td></tr>';
            str += '<tr><td '+stylestr+'> '+US_PSVALUE_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+(psvalue==undefined?"":psvalue)+'</td></tr>';
        }

        $("#tblLineResult").append('<tr><td '+stylestr+'> '+US_ROAD_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+road+'</td></tr>');
        $("#tblLineResult").append('<tr><td '+stylestr+'> '+US_OWNER_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+owner+'</td></tr>');
        $("#tblLineResult").append('<tr><td '+stylestr+'> '+US_BD_TIME_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+bdTime+'</td></tr>');
        $("#tblLineResult").append('<tr><td '+stylestr+'> '+US_STATE_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+state+'</td></tr>');


        str += '<tr><td '+stylestr+'> '+US_ROAD_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+road+'</td></tr>';
        str += '<tr><td '+stylestr+'> '+US_OWNER_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+owner+'</td></tr>';
        str += '<tr><td '+stylestr+'> '+US_BD_TIME_caption+'</td><td '+stylestr+'> '+  "&nbsp;&nbsp;"+bdTime+'</td></tr>';
        str += '<tr><td '+stylestr+'> '+US_STATE_caption+'</td><td '+stylestr+'> '+ "&nbsp;&nbsp;"+state+'</td></tr>';
        return str;
			...
			if(layer.Visibility){		
				...
				for(var pipelnType in [0,1]){
					for (var i = 0, len = layer.GetChildCount(); i < len; i++) {
                        ...
                        param.PageRecordCount = 50;//设置每一页显示的数据为200
            ...
            if (json.Result.num <= 0) {
                ...
                if(bIntersectTandT(clayer,key)){
					// if(type=="point"){//管点，则获取具体类型
						// if(json.Result.Record.COMPONENT !=''){
							// displayType =json.Result.Record.COMPONENT; 
						// }else{
							// displayType =json.Result.Record.FEAT;
						// }
