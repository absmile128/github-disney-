...
//        hideBollon();
    ...
    var showMoveHtml = function(funcChk,title){
        debugger;
        ...
        if(funcChk=="CoverSituation"){
            width = 500;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;  //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/CoverSituation.html";
		}else if(funcChk=="XFSSituation"){//显示所有消防栓状态
            width = 500;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;  //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/XFSSituation.html";
        }else  if(funcChk=="CoverInfo"){
            width = 400;
            height =320;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;  //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/CoverInfo.html";
		}else  if(funcChk=="xfsInfo"){//智能市政简介
            width = 400;
            height =320;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;  //右侧
            ...
            locationy=0;
         //   url=loaclUrl+"/html/cover/CoverInfo.html";
            url=loaclUrl+"/html/cover/XFSInfo.html";
        }  else  if(funcChk=="CoverAlarmSituation"){
            width = 500;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;  //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/CoverAlarmSituation.html";
        }  else  if(funcChk=="XFSAlarmSituation"){//显示消防栓报警状态
            width = 500;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;   //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/XFSAlarmSituation.html";
        }  else  if(funcChk=="HistoryAlarmCoverSituation"){
            width = 500;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;   //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/HistoryAlarmCoverSituation.html";
        }  else  if(funcChk=="HistoryAlarmXFSSituation"){
            width = 500;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;   //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/HistoryAlarmXFSSituation.html";
        }else  if(funcChk=="HistoryCaseSituation"){
            width = 700;
            height =500;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;    //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/cover/HistoryCaseSituation.html";
        } else  if(funcChk=="UserSituation"){
            width = 700;
            height =400;
            var earthframewith=parent.window.document.getElementById ("ifEarth").clientWidth;
            locationx= earthframewith-width/2;    //右侧
            // locationx=0;
            locationy=0;
            url=loaclUrl+"/html/user/UserSituation.html";
        }
        ...
        parent.htmlBalloonMove = earth.Factory.CreateHtmlBalloon(earth.Factory.CreateGuid(), title);
        parent.htmlBalloonMove.SetScreenLocation(locationx,locationy);//earth.offsetHeight
