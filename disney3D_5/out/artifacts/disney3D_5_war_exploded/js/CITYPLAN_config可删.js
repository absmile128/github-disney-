...
CITYPLAN_config.url = {
    ...
    disneydssp: {
        url: "http://10.0.1.142/disneydssp/main2.html"
    }
};
...
CITYPLAN_config.service = {
 ...
 //    authentication: CITYPLAN_config.server.stampMgrIp + '/StampManager2/functionAction.do?method=webServiceList&p=disneysz'
...
CITYPLAN_config.disney = {
    currentPrjGuid:"351e8ceb-bcd8-4470-b445-ebae98dbe115",//当前工程，用于管线开挖、查询
    ...
    cover_layerid : "73b977f4-b2b5-45c4-a691-d73f7797bb8d"   , // 井盖矢量地址
    // cover_layerid : "2e4b9685-81ae-4695-be24-192385926d95"   , // 井盖矢量地址
 ...
 //   FlyObjval:"05306aac-ee93-4faf-85bd-1edbf4569bd3"//飞行物体为摄像机  （cy:飞行路线中强制定义）
      ...
      WebServiceUrl:"http://221.214.110.227:12000/coverservice"
};
